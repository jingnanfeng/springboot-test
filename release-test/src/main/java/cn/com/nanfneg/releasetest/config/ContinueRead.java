package cn.com.nanfneg.releasetest.config;
...
public class ContinueRead  implements SerialPortEventListener { // SerialPortEventListener
   ...
   /* @Override
    ...
    public static void main(String[] args) {
        ...
        if (i == 1) {
            ...
            //cRead.start();
            try {
                String st = "01 05 00 01 FF 00 DD FA";
