...
import cn.com.nanfeng.auth2test.smscode.RedisCodeService;
import cn.com.nanfeng.auth2test.smscode.SmsCode;
...
public class ValidateController {
    ...
    public void createSmsCode(HttpServletRequest request, HttpServletResponse response,
                              @RequestParam("mobile") String mobile) throws Exception {
